  ...
  const displayRecipe = () => {
    ...
    return (
      <div>
        ...
        <div className="recipeInfos"><p>{recipe.recipeInfos}</p></div>

        <div className="recipeDescription"><p>{recipe.recipeDescription}</p></div>

        <div className="ingedients"> <p>{recipe.recipeIngredients}</p> </div>

        <div className="instructions"><p>{recipe.recipeDirections} </p></div>
